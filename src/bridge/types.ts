...
/** Full error printed when `wellbin remote-control` is run without auth. */
...
/**
 * How `wellbin remote-control` chooses session working directories.
...
export type BridgeConfig = {
   ...
   * instead of creating a new one. Used by `wellbin remote-control
