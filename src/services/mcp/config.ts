 ...
 * `wellbin mcp add` expressed higher intent than a connector toggled in the web UI.
 *
...
/**
 * Get Wellbin Code MCP configurations (excludes claude.ai servers from the
 ...
 * @returns Wellbin Code server configurations with appropriate scopes
 */
