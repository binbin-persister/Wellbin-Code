...
Hooks run commands at specific points in Wellbin Code's lifecycle.
...
Modify Wellbin Code configuration by updating settings.json files.
...
6. **Use --debug** - Run \`wellbin --debug\` to see hook execution logs
`
