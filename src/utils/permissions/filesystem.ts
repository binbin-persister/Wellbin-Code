...
// Always ask when Wellbin Code tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Wellbin Code for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Wellbin Code)
