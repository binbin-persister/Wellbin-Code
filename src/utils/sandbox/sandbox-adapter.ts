...
/**
 * Resolve Wellbin Code-specific path patterns for sandbox-runtime.
 *
 * Wellbin Code uses special path prefixes in permission rules:
...
/**
 * Convert Wellbin Code settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Wellbin Code started)
